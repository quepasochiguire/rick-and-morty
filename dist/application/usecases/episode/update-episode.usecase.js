...
let UpdateEpisodeUsecase = class UpdateEpisodeUsecase {
    constructor(episodeService) {
        this.episodeService = episodeService;
    }
    async execute(episodeNumber, season, episodeData) {
...
UpdateEpisodeUsecase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)()),
    __metadata("design:paramtypes", [episode_service_1.EpisodeService])
], UpdateEpisodeUsecase);
exports.default = UpdateEpisodeUsecase;
//# sourceMappingURL=update-episode.usecase.js.map