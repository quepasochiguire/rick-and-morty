...
let CancelEpisodeUsecase = class CancelEpisodeUsecase {
    constructor(episodeService) {
        this.episodeService = episodeService;
    }
    async execute(episodeNumber, season) {
        const episode = await this.episodeService.getEpisode(episodeNumber, season);
        episode.cancel();
        await this.episodeService.suspend(episode);
    }
};
CancelEpisodeUsecase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)()),
    __metadata("design:paramtypes", [episode_service_1.EpisodeService])
], CancelEpisodeUsecase);
exports.default = CancelEpisodeUsecase;
//# sourceMappingURL=cancel-episode.usecase.js.map